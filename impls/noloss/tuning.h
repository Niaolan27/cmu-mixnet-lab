/**
 * STP emission tuning: Scenario 1, the hybrid topology over loss-free links.
 *
 ...
 * root's wave takes to cross the network, hold-downs included.
 */
 ...
 * Links do not lose packets in this scenario, so repeats are insurance
 * rather than the mechanism that carries the tree.
 */
#define FAST_RETRANSMIT_US  10000ull
